    ...
    <div>
		<table class="commonTable" cellspacing="1">
	         <tr>
	            ...
	            <td class="tableContent">${custom_name }</td>
	        ...
	        <tr>
	            ...
	            <td class="tableContent">
					<fmt:formatDate value='${signing_date }' pattern='yyyy-MM-dd' />
				</td>
	        </tr>		
	        <tr>
	            <td class="columnTitle">重要程度：</td>
	            <td class="tableContentAuto">
	            	${import_num==3?"★★★":(import_num==2?"★★":"★") }
	            </td>
	            <td class="columnTitle">船期：</td>
	            <td class="tableContent">
					<fmt:formatDate value='${ship_time }' pattern='yyyy-MM-dd' />
				</td>
	        </tr>		
	        <tr>
	            <td class="columnTitle">贸易条款：</td>
	            <td class="tableContent">${trade_terms }</td>
	            <td class="columnTitle">交货期限：</td>
	            <td class="tableContent">
					<fmt:formatDate value='${delivery_period }' pattern='yyyy-MM-dd' />
				</td>
	        </tr>		
	        <tr>
