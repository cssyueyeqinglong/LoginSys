        ...
        <div>
            <table class="commonTable" cellspacing="1">
                ...
                <tr>
                    ...
                    <td class="tableContent"><input type="text" name="user_name" value=""/></td>
                ...
                <tr>
                    ...
                    <td class="tableContent">
                        <s:select name="userInfo.manager.id" list="userList"
                                  listKey="id" listValue="user_name"
                                  headerKey="" headerValue="--请选择--"
                        ></s:select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="tableContent">
                        <input type="text" style="width:90px;" name="userInfo.join_date"
                               value=""
                ...
                <tr>
                    ...
                    <td class="tableContent"><input type="text" name="userInfo.order_no" value=""/></td>
